...
jQuery(document).on('ready', function() {
	...
	_tg_upcomingeventcounter.countdown('2019/02/18', function(event) {
		var $this = jQuery(this).html(event.strftime(''
			+ '<div class="tg-eventcounterholder"><div class="tg-eventcounter"><span>روز</span><span>%-D</span></div></div>'
			+ '<div class="tg-eventcounterholder"><div class="tg-eventcounter"><span>ساعت</span><span>%H</span></div></div>'
			+ '<div class="tg-eventcounterholder"><div class="tg-eventcounter"><span>دقیقه</span><span>%M</span></div></div>'
			+ '<div class="tg-eventcounterholder"><div class="tg-eventcounter"><span>ثانیه</span><span>%S</span></div></div>'
		));
	});
	/* -------------------------------------
			COUNTER
