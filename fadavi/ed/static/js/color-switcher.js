...
jQuery(document).ready(function($) {
	...
	jQuery("ul.colors .color1" ).on('click', function(){
		jQuery("#colors" ).attr("href", "{% static 'css/colors/default.css' %}" );
		return false;
	});
	jQuery("ul.colors .color2" ).on('click', function(){
		jQuery("#colors" ).attr("href", "{% static 'css/colors/color-2.css' %}" );
		return false;
	});
	jQuery("ul.colors .color3" ).on('click', function(){
		jQuery("#colors" ).attr("href", "{% static 'css/colors/color-3.css' %}" );
		return false;
	});
	jQuery("ul.colors .color4" ).on('click', function(){
		jQuery("#colors" ).attr("href", "{% static 'css/colors/color-4.css' %}" );
		return false;
	});
	jQuery("ul.colors .color5" ).on('click', function(){
		jQuery("#colors" ).attr("href", "{% static 'css/colors/color-5.css' %}" );
		return false;
	});
...
jQuery('head').append('<link rel="stylesheet" id="colors" href='+"{% static 'css/colors/default.css' %}"+'>');
jQuery('head').append('<link rel="stylesheet" href='+"{% static 'css/color-switcher.css' %}"+'>'); 
